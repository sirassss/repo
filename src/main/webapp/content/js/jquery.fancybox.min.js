...
!(function (t, e, n, o) {
  ...
  function i(t) {
    ...
    t.preventDefault(),
      t.stopPropagation(),
      a
        ? ((i = i.length ? i.filter('[data-fancybox="' + a + '"]') : n('[data-fancybox="' + a + '"]')), (s = i.index(e)), s < 0 && (s = 0))
        : (i = [e]),
  ...
  if (n) {
    ...
    n.extend(h.prototype, {
        ...
        n.each(i, function (t, i) {
          ...
          n.isPlainObject(i)
            ...
            'auto' == l.opts.smallBtn &&
              (n.inArray(s, ['html', 'inline', 'ajax']) > -1 ? ((l.opts.toolbar = !1), (l.opts.smallBtn = !0)) : (l.opts.smallBtn = !1)),
      ...
      updateSlide: function (t) {
        ...
        o &&
          (t.width || t.height) &&
          (n.fancybox.stop(o), n.fancybox.setTranslate(o, e.getFitPos(t)), t.pos === e.currPos && e.updateCursor()),
      ...
      focus: function () {
        var t,
          e = this.current;
        this.isClosing ||
          ((t = e && e.isComplete ? e.$slide.find('button,:input,[tabindex],a').filter(':not([disabled]):visible:first') : null),
        ...
        i.type ||
          ...
          h
            ? ((i.src = f),
              ...
              'iframe' === h &&
                (t.extend(!0, i.opts, { iframe: { preload: !1, attr: { scrolling: 'no' } } }),
                (i.contentProvider = d),
                (i.opts.slideClass += ' fancybox-slide--' + ('google_maps' == d ? 'map' : 'video'))))
            : (i.type = 'image'));
      });
    });
  })(window.jQuery),
    ...
    (u.prototype.destroy = function () {
          ...
          ? Math.abs(a.distance) > 10 &&
            ...
            a.instance.group.length < 2 && a.instance.opts.touch.vertical
              ...
              : a.instance.isSliding ||
                ...
                ('auto' === a.instance.opts.touch.vertical && n(t).width() > 800)
              ? (a.isSwiping = 'x')
      ...
      (u.prototype.limitMovement = function (t, e, n, o) {
        ...
        return (
          ...
          n > l &&
            (h > 0 && t > i && (t = i - 1 + Math.pow(-i + d + h, 0.8) || 0), h < 0 && t < s && (t = s + 1 - Math.pow(s - d - h, 0.8) || 0)),
          o > u &&
            (p > 0 && e > a && (e = a - 1 + Math.pow(-a + f + p, 0.8) || 0), p < 0 && e < r && (e = r + 1 - Math.pow(r - f - p, 0.8) || 0)),
          { top: e, left: t }
        );
      }),
        ...
        (e.instance.isSliding = !1),
          ...
          'y' == t && Math.abs(e.distanceY) > 50
            ? (n.fancybox.animate(
                ...
                { top: e.sliderStartPos.top + e.distanceY + 150 * e.velocityY, opacity: 0 },
                150
              ),
    ...
    e(t).on({
      ...
      e(t).on(n.fullscreenchange, function () {
        ...
        t.current &&
          ...
          t.isAnimating &&
          (t.current.$content.css('transition', 'none'), (t.isAnimating = !1), t.update(!0, !0, 0));
      });
  })(document, window.jQuery),
  (function (t, e) {
    'use strict';
    ...
    e.extend(n.prototype, {
      ...
      update: function () {
        this.instance.$refs.container.toggleClass('fancybox-show-thumbs', this.isVisible),
          this.isVisible
            ? (this.$grid || this.create(), this.instance.trigger('onThumbsShow'), this.focus())
      ...
      setTimeout(function () {
        n.fancybox.defaults.hash !== !1 &&
          ...
          n(e).on('hashchange.fb', function () {
            var t = o();
            n.fancybox.getInstance()
              ? !s || s === t.gallery + '-' + t.index || (1 === t.index && s == t.gallery) || ((s = null), n.fancybox.close())
              : '' !== t.gallery && i(t);
          }),
