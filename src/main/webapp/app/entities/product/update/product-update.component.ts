...
import { IManufactured, Manufactured } from '../../manufactured/manufactured.model';
import { NgbActiveModal, NgbModal, NgbModalRef } from '@ng-bootstrap/ng-bootstrap';
import { IProductDetails } from '../../product-details/product-details.model';
import { DECIMAL, THOUSANDS, TypeID } from '../../../app.constants';
...
export class ProductUpdateComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.product = {};
    this.productDetail = {};
    this.manufacturedService.query().subscribe(res => {
      if (res && res.body) {
  ...
  save(): void {
    this.isSaving = true;
    this.productDetail.imageUrl = this.url;
    this.product.productDetails = [];
    this.product.productDetails.push(this.productDetail);
  ...
  protected updateForm(product: IProduct): void {
    ...
    if (this.productDetail.imageUrl) {
      this.url = this.productDetail.imageUrl;
    }
  }
