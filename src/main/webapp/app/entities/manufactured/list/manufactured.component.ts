...
export class ManufacturedComponent implements OnInit {
  ...
  delete(manufactured: IManufactured): void {
    const modalRef = this.modalService.open(ManufacturedDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.manufactured = manufactured;
